...
# dataset = os.path.sep.join([dataDir, "TrainImage"])
dataset = imageDir + "/TrainImage"
embeddings = dataDir + "/embeddings.pickle"
detector = modelDir
embeddingsModel = modelDir + "/openface_nn4.small2.v1.t7"
...
embedder = cv2.dnn.readNetFromTorch(embeddingsModel)
